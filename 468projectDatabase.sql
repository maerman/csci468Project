...
CREATE TABLE IF NOT EXISTS `affablebean`.`product` (
  ...
  `description` VARCHAR(8000) NULL,
  `last_update` TIMESTAMP(0) NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `review_adv` FLOAT UNSIGNED NULL,
